...
export default function App(){
  ...
  async function addRes(r){try{const id=await monday.createResource(r);setData(p=>({...p,resources:[...p.resources,{...r,id,createdAt:TODAY}]}));}catch(e){console.error("addRes failed",e);}}
  async function addO(o){try{const id=await monday.createOfficer(o);setData(p=>({...p,officers:[...p.officers,{...o,id,avatar:mkA(o.name),joinedDate:TODAY}],teams:p.teams.includes(o.team)?p.teams:[...p.teams,o.team]}));}catch(e){console.error("addO failed",e);}}
